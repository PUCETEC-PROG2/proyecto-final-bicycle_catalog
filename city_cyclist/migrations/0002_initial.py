# Generated by Django 4.2 on 2024-08-11 02:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, max_digits=10, validators=[django.core.validators.MinValueValidator(100.0, message='La bicicleta más económica cuesta $100')])),
                ('stock', models.PositiveIntegerField()),
                ('description', models.TextField(blank=True, null=True)),
        ...
        migrations.AddField(
            model_name='bike',
            name='brands',
            field=models.ManyToManyField(to='city_cyclist.brandbikes'),
        ),
        migrations.AddField(
            model_name='bike',
            name='categories',
        ...
        migrations.AddField(
            ...
            name='brands',
            field=models.ManyToManyField(to='city_cyclist.brandaccessories'),
        ),
        migrations.AddField(
            model_name='accessories',
            name='categories',
