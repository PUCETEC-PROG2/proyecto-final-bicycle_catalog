    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_category', models.CharField(choices=[('Luces', 'Luces'), ('Aros', 'Aros'), ('Frenos', 'Frenos'), ('Casco', 'Casco'), ('Pedales', 'Pedales'), ('Rueda', 'Rueda')], max_length=30)),
                ...
                ('brand', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='city_cyclist.brandproducts')),
